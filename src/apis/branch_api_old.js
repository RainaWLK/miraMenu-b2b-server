...
/*
//============== i18n =========================
api.get('/restaurants/{restaurant_id}/branches/{branch_id}/i18n', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.post('/restaurants/{restaurant_id}/branches/{branch_id}/i18n', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.get('/restaurants/{restaurant_id}/branches/{branch_id}/i18n/{i18n_id}', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.patch('/restaurants/{restaurant_id}/branches/{branch_id}/i18n/{i18n_id}', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.delete('/restaurants/{restaurant_id}/branches/{branch_id}/i18n/{i18n_id}', async (req) => {
  let cmdObj = new Branches.main(req);
...
//============== Resources =========================
api.get('/restaurants/{restaurant_id}/branches/{branch_id}/resources', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.post('/restaurants/{restaurant_id}/branches/{branch_id}/resources', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.get('/restaurants/{restaurant_id}/branches/{branch_id}/resources/{resource_id}', async (req) => {
  let cmdObj = new Branches.main(req);
...
api.delete('/restaurants/{restaurant_id}/branches/{branch_id}/resources/{resource_id}', async (req) => {
  let cmdObj = new Branches.main(req);
